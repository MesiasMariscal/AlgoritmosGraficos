            ...
            switch (tipo)
            {
                ...
                case "Relleno":
                    instructionLabel.Text = "Algoritmo de relleno:\n" +
                                           ...
                                           "3. Presione 'Animar' para ver el proceso";
                    break;
                case "Recorte de líneas Cohen-Sutherland":
                    instructionLabel.Text = "Algoritmo Cohen-Sutherland:\n" +
                                           "1. Haga clic para definir el primer punto de la línea\n" +
                                           "2. Haga clic para definir el segundo punto\n" +
                                           "3. Vea el resultado del recorte instantáneamente";
                    break;
                case "Recorte de polígonos Sutherland-Hodgman":
                    instructionLabel.Text = "Algoritmo Sutherland-Hodgman:\n" +
                                           "1. Haga clic para agregar puntos al polígono (mín. 3)\n" +
                                           "2. Vea el recorte en tiempo real\n" +
                                           "3. Presione ESC para limpiar el polígono";
                    break;
                case "Curvas de Bézier":
                    instructionLabel.Text = "Curvas de Bézier cúbicas:\n" +
                                           "1. Haga clic para agregar puntos de control (mín. 4)\n" +
                                           "2. Arrastra los puntos rojos para modificar la curva\n" +
                                           "3. Presione ESC para limpiar los puntos";
                    break;
                case "B-splines":
                    instructionLabel.Text = "Curvas B-spline:\n" +
                                           "1. Haga clic para agregar puntos de control (mín. 4)\n" +
                                           "2. Arrastra los puntos azules para modificar la curva\n" +
                                           "3. Presione ESC para limpiar los puntos";
                    break;
                default:
